...
var intersectionWith$1 = /*#__PURE__*/liftMaybe(R.intersectionWith);
...
var mapElemsWithIds = /*#__PURE__*/infestines.curry(function (idOf, xi2y, xsIn) {
  var id2info = {};
  var find$$1 = partial_lenses.findHint(function (x, info) {
    return idOf(x) === info.id;
  });
  return infestines.seq(xsIn, foldPast(function (ysOld, xs) {
    var n = xs.length;
